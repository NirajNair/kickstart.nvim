...
--
-- NOTE: Below keybinds are commented because we are using vim-tmux-navigator to move between neovim and tmux panes
-- Check `vim-tmux-navigator` plugin file to understand the new keybinds
